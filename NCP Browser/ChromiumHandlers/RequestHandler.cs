...
using System;
using NCP_Browser.SchemeHandlers;
using NCP_Browser.Filters;
...
namespace CefSharp.Example
{
    public class RequestHandler : IRequestHandler
    {
        ...
        void IRequestHandler.OnRenderProcessTerminated(IWebBrowser browserControl, IBrowser browser, CefTerminationStatus status)
        {
            ...
            browserControl.Load("about:blank");
        }
        ...
        {
            return url.StartsWith(NCP_Browser.Salesforce.RenderProcessCrashedUrl);
        }
        ...
        IResponseFilter IRequestHandler.GetResourceResponseFilter(IWebBrowser browserControl, IBrowser browser, IFrame frame, IRequest request, IResponse response)
        {
            ...
            if (url.Scheme == CefSharpSchemeHandlerFactory.SchemeName)
            {
                if(request.Url.Equals(NCP_Browser.Salesforce.ResponseFilterTestUrl, StringComparison.OrdinalIgnoreCase))
                {
